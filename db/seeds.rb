...
game_four = Game.create(game_name: "Fifa 22", description: "Try to build the best team possible", price: 125, user: user_two)
...
game_ten = Game.create(game_name: "The Witcher 3", description: "Have the best bow and explore the world", price: 275, user: user_three )
